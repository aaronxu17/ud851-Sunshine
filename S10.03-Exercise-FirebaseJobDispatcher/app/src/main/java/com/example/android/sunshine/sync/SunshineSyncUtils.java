...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int SYNC_FLEXIBLE_SECONDS = SYNC_INTERVAL_SECONDS/3;
...
//  TODO (12) Create a method to schedule our periodic weather sync
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context){
        ...
        Job syncSunshineJob = dispatcher.newJobBuilder().setService(SunshineFirebaseJobService.class)
                .setTag(SUNSHINE_SYNC_TAG)
                .setConstraints(Constraint.ON_ANY_NETWORK)
                .setLifetime(Lifetime.FOREVER)
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(SYNC_INTERVAL_SECONDS, SYNC_FLEXIBLE_SECONDS+SYNC_INTERVAL_SECONDS))
