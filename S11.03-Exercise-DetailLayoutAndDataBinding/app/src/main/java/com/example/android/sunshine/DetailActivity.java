...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryInfo.highTemp.setText(highString);
        mDetailBinding.primaryInfo.highTemp.setContentDescription(highA11y);
        /*************************
         * Low (min) temperature *
         *************************/
...
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryInfo.lowTemp.setText(lowString);
        mDetailBinding.primaryInfo.lowTemp.setContentDescription(lowA11y);
...
//      TODO (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraDetail.humidity.setText(humidityA11y);

//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraDetail.humidityLabel.setContentDescription(humidityA11y);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraDetail.windMeasurement.setText(windString);
        mDetailBinding.extraDetail.windMeasurement.setContentDescription(windA11y);

//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraDetail.windLabel.setContentDescription(windA11y);
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraDetail.pressure.setContentDescription(pressureAlly);

//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraDetail.pressureLabel.setContentDescription(pressureAlly);
